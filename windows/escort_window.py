...
class EscortWindow(BaseWindow):

    def __init__(self, parent):
        super().__init__(parent, width=520, height=300, title='Автоформирование сопроводительного письма')
    ...
    def create_doc(self):
        ...
        name = f'documents/сопроводы/{get_time()}.odt'
        create_document(name, data_rows, template_path='templates/escort.odt')
